	...
	*/
	...
	$Content .= '<div class="contentbox">';
		$Content .= '<div class="mainPad">';
			...
			$Content .= '<div style="display:block;text-align:center;width:100%;margin:0;"><div style="display:inline-block;margin:20px auto;"><iframe width="440" height="200" src="https://www.youtube.com/embed/Kr_iy580Zsw?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe></div></div>';
