<?php
	...
	$cust = false;
	if($cust){
		$Content .= '<div class="contentbox" id="General" style="background: #EF1022;color: white;padding: 30px 0;">';
			$Content .= '<p style="color: white;text-align: center;font-weight: bold;margin: 0 30px;">We are closed on Sunday 1st July due to Malton Show. Please feel free to attend the show at the picturesque Scampston Park only 2 miles from our showroom where we have a large display of classic vehicles.</p>'."\r\n";
		$Content .= '</div>'."\r\n";
	}
